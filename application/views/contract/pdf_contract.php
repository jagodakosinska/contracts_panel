...
<div class="contract__container">
    <h1 class="contract__title"> UMOWA O DZIEŁO</h1>
        ...
        <p class="contract__content">Umowa zawarta w dniu <span class="contract__important"><?= $contract->bdate ?></span>, we Wrocławiu, pomiędzy stronami umowy:
        <br>
        ...
        <p class="contract__content">
            Termin rozpoczęcia dzieła strony ustaliły na dzień <span class="contract__important"><?= $contract->bdate ?></span> a wykonania na dzień <span class="contract__important"><?= $contract->edate ?></span>.
        </p>
        <br>
        <h3 class="contract__paragraf">§ 3</h3>
        <p class="contract__content">
            Wykonawcy przysługuje wynagrodzenie za wykonanie dzieła w wysokości ................ zł. 
            Zamawiający wypłaci Wykonawcy wynagrodzenie w formie <?= $employee->bank_transfer == 1 ? 'przelewu' : 'gotówki' ?> 
